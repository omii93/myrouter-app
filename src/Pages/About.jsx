    ...
    return (
        <div className="container-fluid">
            ...
            <section className="  row justify-content-center p-5">
                ...
                <div className="col-12 col-lg-6">
                    <img src="public\Images\Illustration\welcome.jpg" alt="Welcome" width="100%" />
                </div>
            </section>
            ...
            <section className='row justify-content-around s3 m-3 mt-5 '>
                <div className='col-11 col-md-5'>
                    ...
                    <div className='d-flex align-items-center mb-5 mt-5'>
                        <div><img src="public\Images\Illustration\testimonial-2.jpg" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt="" /></div>
