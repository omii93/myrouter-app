...
const Causes = () => {
    return (
        <div className="container-fluid">
            <section className='About row text-white text-start' id='About1'>
                    ...
                    <div className="col-11   ">
                        ...
                        <div className="row justify-content-between justify-content-lg-center">
                            <div className="col-12 col-lg-5 py-5 bg-light me-lg-3">
                                <div className="row justify-content-center">
                                    <div className="col-12 col-md-5 col-lg-12">
                                        <img src="src\assets\Images\Illustration\eye-for.jpg" alt="" width="100%"/>
                                    </div>
                            ...
                            <div className="col-12 col-lg-5 py-5 mt-5 mt-lg-0  ms-lg-3 bg-light">
                                <div className="row justify-content-center">
                                    <div className="col-12 col-md-5 col-lg-12">
                                        <img src="src\assets\Images\Illustration\featured-causes.jpg" alt="" width="100%"/>
                                    </div>
                                    <div className="col-12 col-md-5 col-lg-11">
                                        <div className="">
                                            <h2><a href="" className="text-decoration-none text-dark">Fundraiser for Kids</a></h2>
...
<section className="row py-5 justify-content-center" id="ourCauses">
          <div className="col-11 col-md-8 col-lg-5 me-md-3  col-xl-3 bg-white p-0">
            ...
            <div>
              <img src="src\assets\Images\Illustration\cause-1.jpg" alt="cause-1" width="100%" />
            </div>
            <div className="p-2">
              <div>
          ...
          <div className="col-11 col-md-10 col-lg-5 col-xl-3 ms-md-3 me-xl-3 bg-white p-0 d-none d-lg-block">
            ...
            <div>
              <img src="src\assets\Images\Illustration\cause-2.jpg" alt="cause-1" width="100%" />
            </div>
            <div className="p-2">
              <div>
          ...
          <div className="col-11 col-md-8 col-lg-5 bg-white p-0 d-none d-xl-block  col-xl-3 ms-3">
            ...
            <div>
              <img src="src\assets\Images\Illustration\cause-3.jpg" alt="cause-1" width="100%" />
            </div>
            <div className="p-2">
              <div>
                <h3 className="my-3 "> <a href="#" className="text-decoration-none text-black">Bringe Water to the
        ...
        <section className="row justify-content-center p-5 text-white bg-dark">
                ...
                <div className="col-12 col-lg-6">
                    <img src="src\assets\Images\Illustration\oshomah.jpg" alt="Welcome" width="100%" />
                </div>
            </section>
          ...
          <div className="col-11 col-md-8 col-lg-5 me-md-3  col-xl-3 bg-white p-0">
            ...
            <div>
              <img src="src\assets\Images\Illustration\cause-4.jpg" alt="cause-1" width="100%" />
            </div>
            <div className="p-2">
              <div>
                <h3 className="my-3 "> <a href="#" className="text-decoration-none text-black">Bringe Water to the
          ...
          <div className="col-11 col-md-10 col-lg-5 col-xl-3 ms-md-3 me-xl-3 bg-white p-0 d-none d-lg-block">
            ...
            <div>
              <img src="src\assets\Images\Illustration\cause-5.jpg" alt="cause-1" width="100%" />
            </div>
            <div className="p-2">
              <div>
                <h3 className="my-3 "> <a href="#" className="text-decoration-none text-black">Education for all
          ...
          <div className="col-11 col-md-8 col-lg-5 bg-white p-0 d-none d-xl-block  col-xl-3 ms-3">
            ...
            <div>
              <img src="src\assets\Images\Illustration\cause-6.jpg" alt="cause-1" width="100%" />
            </div>
            <div className="p-2">
              <div>
                <h3 className="my-3 "> <a href="#" className="text-decoration-none text-black">Bringe Water to the
