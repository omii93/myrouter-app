      ...
      <section className="container-fluid">
        ...
        <section>
          <div className="row justify-content-center my-5 text-center">
            ...
            <div
              ...
              <div className="text-center mx-auto">
              <img src="/Images/Illustration/charity-gray.png" alt="" className="image2" /></div>
            ...
            <div className="col-11 col-lg-6">
              ...
              <div className="row justify-content-between">
                <div className="col-5 col-md-4">
                  <img src="public/Images/Illustration/event-1.jpg" alt="" />
                </div>
              ...
              <div className="row justify-content-between mt-lg-4">
                <div className="col-5 col-md-4"><img src="public/Images/Illustration/event-2.jpg" alt="" /></div>
                <div className="col-6 col-md-8">
                  <div className="shov">
                    <h2><a href="" className="text-decoration-none text-dark">Fundraiser for
                      Kids</a></h2>
              ...
              {/* <!-- third div --> */}
              <div className="row justify-content-between mt-lg-4">
                <div className="col-5 col-md-4"><img src="public/Images/Illustration/event-3.jpg" alt="" /></div>
                <div className="col-6 col-md-8">
                  <div className="shov">
                    <h2><a href="" className="text-decoration-none text-dark">Fundraiser for
                      Kids</a></h2>
            ...
            <div className="col-11 col-lg-5">
              ...
              <div className="row justify-content-center">
                <div className="col-12 col-md-5 col-lg-12">
                  <img src="public/Images/Illustration/featured-causes.jpg" alt="" width="100%" />
                </div>
        ...
        <section className="row py-5 justify-content-center" id="ourCauses">
          <div className="col-11 col-md-8 col-lg-5 me-md-3  col-xl-3 bg-white p-0">
            ...
            <div>
              <img src="public/Images/Illustration/cause-1.jpg" alt="cause-1" width="100%" />
            </div>
            <div className="p-2">
              <div>
          ...
          <div className="col-11 col-md-10 col-lg-5 col-xl-3 ms-md-3 me-xl-3 bg-white p-0 d-none d-lg-block">
            ...
            <div>
              <img src="public/Images/Illustration/cause-2.jpg" alt="cause-1" width="100%" />
            </div>
            <div className="p-2">
              <div>
          ...
          <div className="col-11 col-md-8 col-lg-5 bg-white p-0 d-none d-xl-block  col-xl-3 ms-3">
            ...
            <div>
              <img src="public/Images/Illustration/cause-3.jpg" alt="cause-1" width="100%" />
            </div>
            <div className="p-2">
              <div>
                <h3 className="my-3 "> <a href="#" className="text-decoration-none text-black">Bringe Water to the
